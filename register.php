      ...
      <div class="card-body">
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
                <input type="text" name="middlename" id="middlename" placeholder="Enter Middle Name" class="form-control form-control-sm form-control-border">
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <textarea name="address" id="address" rows="3" class="form-control form-control-sm rounded-0" placeholder="Address"></textarea>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="form-group col-md-6">
                <input type="email" name="email" id="email" placeholder="user@sample.com" class="form-control form-control-sm form-control-border" required>
